...
public class 별점드래그 extends BF {
	private JLabel dis = new JLabel("0.0");
	...
	public 별점드래그() {
		...
		getContentPane().add(new MyLabel() {{setBounds(0, 0, 500, 300);}});
		dis.setBounds(60, 60, getWidth(), getHeight());
